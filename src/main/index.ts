...
import { registerCareerProfilesIPC } from './ipc/career-profiles.ipc';
import { registerWireTransferIPC } from './ipc/wire-transfer.ipc';
...
function registerIPC(): void {
  ...
  registerProjectsIPC();
  registerHrIPC();
  registerCareerProfilesIPC();
  registerWireTransferIPC();
