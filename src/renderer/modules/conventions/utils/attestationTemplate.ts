...
export const ATTESTATION_VARIABLE_GROUPS: VariableGroup[] = [
  {
    ...
    items: [
      ...
      { token: 'attestation.prixTotalBien', label: 'Prix total du bien' },
      { token: 'attestation.prixTotalBien.enLettres', label: 'Prix total du bien (en lettres)' },
...
export function resolveAttestationVariables(
  ...
  return {
    ...
    'attestation.prixTotalBien': money(a.prixTotalBien),
    'attestation.prixTotalBien.enLettres': moneyL(a.prixTotalBien),
