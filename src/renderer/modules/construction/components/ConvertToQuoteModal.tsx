...
import { useEstimateToQuote } from '../hooks/useConstructionEstimates';
...
export default function ConvertToQuoteModal({ open, onClose, estimate }: { open: boolean; onClose: () => void; estimate: any }) {
  ...
  // recherche ne doit pas être bornée aux 500 premiers enregistrements préchargés.
  ...
  const toQuote = useEstimateToQuote();
