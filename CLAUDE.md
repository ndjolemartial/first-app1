...
- `documents:import` — Importer un ou plusieurs fichiers dans la GED (rattachements optionnels, dont `crmActivityId` pour les pièces jointes d'activité CRM et `socialPublicationId` pour les pièces jointes de publication)
