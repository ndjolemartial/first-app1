...
function registerTreasuryIPC() {
    ...
    electron_1.ipcMain.handle('treasury:createOperation', async (_event, { token, payload }) => {
        try {
            ...
            const operation = await (0, treasury_service_1.recordTreasuryOperation)(db, {
            ...
            logger_1.default.info(`Opération de trésorerie créée: ${operation.reference} (${d.direction} ${d.amount})`);
