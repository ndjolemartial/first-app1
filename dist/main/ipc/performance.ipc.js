...
const kpiSchema = zod_1.z.object({
    ...
    source: zod_1.z.enum(['SALES', 'COMMISSIONS', 'ACCOUNTING', 'CRM', 'PROSPECTS', 'ATTENDANCE', 'LEAVE', 'PROJECT', 'SOCIAL', 'IT_INNOVATION', 'MANUAL']),
    metric: zod_1.z.enum([
        'SALES_COUNT', 'SALES_AMOUNT', 'RESILIATION_COUNT', 'COMMISSION_AMOUNT', 'ENCAISSEMENT_AMOUNT', 'RECOVERY_RATE',
        ...
        'ATTENDANCE_RATE', 'OVERTIME_HOURS', 'ABSENCE_DAYS', 'LATE_EARLY_DEPARTURE_HOURS',
        'IT_INNOVATIONS_IMPLEMENTED', 'MANUAL_VALUE',
    ]),
