...
exports.numberToFrenchWords = numberToFrenchWords;
exports.moneyToFrenchWords = moneyToFrenchWords;
const UNITS = [
...
function threeDigit(n, final) {
    ...
    if (rest === 0)
        return final ? `${UNITS[c]} cents` : `${UNITS[c]} cent`;
 ...
 */
function moneyToFrenchWords(amount, options = {}) {
